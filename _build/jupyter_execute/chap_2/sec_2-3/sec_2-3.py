...
# 散布図を描くと明らかな規則性が見いだせる場合もあるが，通常はおおまかに以下の３つのいずれかに当てはまるか検討する：
# 
# - 散布図が右上がり：正の相関
# - 散布図が右下がり：負の相関
# - 散布図が広い範囲に一様にばらついている：無相関
# 
...
# $$(eq:correlation)
# 
# また，分散公式{eq}`eq:deviation2`を用いると，以下のように表すこともできる：
# 
# $$
...
# そこで，共分散を$ X,\ Y $の標準偏差$s_{X},\ s_{Y}$で割って，各変数の単位やばらつきの度合いに依らない量としたのが相関係数である．
# 
