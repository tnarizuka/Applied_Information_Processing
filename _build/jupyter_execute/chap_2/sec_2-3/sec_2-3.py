...
# 変数$ X,\ Y $の散布図に右上がりや右下がりの傾向などがある場合には相関関係があるという．
# 例えば，アヤメの花弁については，長さ（Petal Length）と幅（Petal Width）に相関関係がある．
# 
...
# ```
# 共分散は各データごとに$ X,\ Y $の偏差（平均との差）の積を考え，それらを全データに対して平均している．
# これにより，確かに散布図が右上がりのときに正，右下がりのときには負となる．
